    ...
    properties: {
      ...
      type: {
        ...
        description: "파편 유형. fact=사실, decision=의사결정, error=에러, " +
                             "preference=사용자 선호, procedure=절차, relation=관계, episode=에피소드"
      },
      keywords: {
        type       : "array",
        items      : { type: "string" },
...
export const getSkillGuideDefinition = {
  ...
  description: "Memento MCP 최적 활용 가이드를 반환한다. " +
                 ...
                 "에피소드 기억 활용법, 다중 플랫폼 관리 등 포괄적 스킬 레퍼런스. " +
    ...
    properties: {
      section: {
        ...
        description: "특정 섹션만 조회. 미지정 시 전체 가이드 반환. " +
                     "가능한 값: overview, lifecycle, keywords, search, episode, multiplatform, tools, importance"
      }
    }
  }
};
...
export const searchTracesDefinition = {
  name       : "search_traces",
  description: "fragments를 선택적으로 탐색한다. " +
               "event_type, entity, 키워드로 필터링하여 전체 히스토리를 grep하듯 조회한다.",
  inputSchema: {
    type      : "object",
    properties: {
