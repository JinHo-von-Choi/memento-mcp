...
export const recallDefinition = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      timeRange: {
        type       : "object",
        description: "시간 범위 필터 (created_at 기준)",
        properties : {
          from: { type: "string", description: "시작 날짜 (ISO 8601, 예: 2026-03-15)" },
          to  : { type: "string", description: "종료 날짜 (ISO 8601, 예: 2026-03-16)" }
        }
      }
    }
  }
