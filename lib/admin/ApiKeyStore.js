...
export async function validateApiKeyFromDB(rawKey) {
  ...
  return { valid: true, keyId: key.id, groupKeyIds, permissions: key.permissions, fragmentLimit: key.fragment_limit, defaultWorkspace: key.default_workspace ?? null, defaultMode: key.default_mode ?? null };
}
