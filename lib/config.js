...
export const SESSION_TTL_MS     = Number(process.env.SESSION_TTL_MINUTES || 240) * 60 * 1000;
...
/** OAuth 허용 Redirect URI (정확 일치, 쉼표 구분 환경변수로 추가 가능) */
/**
 * OAuth redirect_uri 신뢰 도메인 (origin 단위 허용)
 * 해당 도메인의 모든 경로가 허용됨 (ChatGPT connector 등 동적 경로 대응)
 */
