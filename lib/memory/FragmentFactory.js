...
export class FragmentFactory {
  ...
  create(params) {
    ...
    const maxLen    = params.type === "episode" ? MAX_EPISODE_FRAGMENT_LENGTH : MAX_FRAGMENT_LENGTH;
    const truncated = redactedContent.length > maxLen
      ? `${redactedContent.substring(0, maxLen)}...`
      : redactedContent;
