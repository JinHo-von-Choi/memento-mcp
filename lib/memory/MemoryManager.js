...
export class MemoryManager {
        ...
        try {
          ...
          const insertSql = `INSERT INTO ${SCHEMA}.fragments
                    (id, content, topic, keywords, type, importance, content_hash,
                     source, linked_to, agent_id, ttl_tier, estimated_tokens, valid_from, key_id, is_anchor, workspace, embedding)
  ...
  async reconstructHistory(params) {
    const reconstructor = new HistoryReconstructor(this.store, this.store.links);
